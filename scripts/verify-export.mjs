...
const root = gltf.scene.children.find(object => object.userData.design?.type === 'original-artistic-pavilion');
assert.ok(root);
...
const grass = root.userData.detailCounts.grass;
assert.equal(grass.blades, (grass.island + grass.arrival) * 6);
